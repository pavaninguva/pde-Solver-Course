...
from fipy import Variable, FaceVariable, CellVariable, Grid1D, ExplicitDiffusionTerm, TransientTerm, DiffusionTerm, Viewer, TSVViewer
...
# Suppose we have things working and we want to output usable data and not rely on the default viewer:
